...
def dashboard():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render_template('dashboard.html', resultados=resultados, eq_diff=eq_diff, var_entrada=var_entrada, var_saida=var_saida, metodo_sintonia=metodo_sintonia)
...
def admin():
    ...
    if usuario.email != 'admin@seusite.com':
